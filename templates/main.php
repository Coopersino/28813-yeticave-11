        ...
        <ul class="promo__list">
            <?php foreach ($categories as $category): ?>
                <li class="promo__item promo__item--<?= $category['categor_code'] ?>">
                    <a class="promo__link"
                       href="index.php?id=<?= htmlspecialchars($category['id']); ?>"><?= htmlspecialchars($category['categor_name']); ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </section>
                ...
                <li class="lots__item lot">
                    ...
                    <div class="lot__info">
                        ...
                        <h3 class="lot__title"><a class="text-link"
                                                  href="lot.php?id=<?= $advertisement['id'] ?>"><?= htmlspecialchars($advertisement['adv_name']) ?></a>
                        </h3>
