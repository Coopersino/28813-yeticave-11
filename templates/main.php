      ...
      <?php foreach ($advertisements as $advertisement): ?>
        <li class="lots__item lot">
          <div class="lot__image">
            <img src="img/<?= htmlspecialchars($advertisement['img_url']) ?>" width="350" height="260" alt="">
          </div>
          <div class="lot__info">
            <span class="lot__category"><?= htmlspecialchars($advertisement['categor_name']) ?></span>
            <h3 class="lot__title"><a class="text-link"
                                      href="lot.php?id=<?=$advertisement['id']?>"><?= htmlspecialchars($advertisement['adv_name']) ?></a></h3>
